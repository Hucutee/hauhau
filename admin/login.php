...
<?php
	...
	if(isset($_POST['login'])){
		...
		$sql="select * from NhanVien where MSNV='$username' and MatKhau=md5('$password') limit 1 ";
		$row=mysql_query($sql);
...
<div id="login">
    ...
    <h2>Đăng nhập</h2>
    <input type="text" name="username" id="username" placeholder="Enter MSNV..." required="required" />
